...
public class UISprite : UIWidget
{
	...
	protected override void OnStart ()
	{
		if (mAtlas != null)
		{
			UpdateUVs(true);
			// hook sprite Name
			string TmpSpriteName  = mSpriteName + DataManager.Instance.Language;
			// check this SpriteName is exist
			UIAtlas.Sprite sp = mAtlas.GetSprite(TmpSpriteName);
			if (sp == null) return;
			spriteName = TmpSpriteName;
			//MakePixelPerfect();
		}
	}
